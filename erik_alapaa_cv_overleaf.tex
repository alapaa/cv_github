...
\resumeHeadingListStart{}
    ...
    \resumeSectionType{Languages}{:}{C++, C, Python, Perl, bash, awk/sed,
      Matlab, Maple}
    ...
    \resumeSectionType{Frameworks/APIs}{:}{Boost Graph Library, Pthreads, gRPC,
      BSD sockets, TCP/IP, SCTP, Google Protobuf (open source), Google Abseil
      C++ Common Libraries (open source)}
